 ...
 * 数据结构：
 * {
 *   basic:     { name, gender, birthDate, phone, email, idCard, politicalStatus, highestDegree,
 ...
 *   internships: [ { company, position, start, end, description } ],
  ...
  emptyProfile() {
    return {
      basic: {
        ...
        politicalStatus: '', highestDegree: '', nativePlace: '', currentCity: '',
        expectedCity: '', expectedSalary: '', address: '', qq: '', wechat: '', englishLevel: ''
      },
      education: [],
      projects: [],
      internships: [],
